...
![Annapurna Logo](https://i.imgur.com/iHbhLYO.png)

# What is Annapurna?
Named after the Hindu goddess of food and nourishment, Annapurna is a centralized source of truth for farmers to gain insights for their land. Our software allows farmers to optimally plan farm layouts and maximise efficiency and revenue. The user is able to indicate plots of land where they want to plant and indicate the crop they want to plant there. Based on real-time data about air quality, soil and weather conditions, *Annapurna* will determine how suitable a particular area is for planting a particular crop, and provide a general estimation on the expected value of a plot. 

1. Show Annapurna the land you're working with
...
- **Realtime, Relevant Data**: Annapurna provides all the data that you need to make the best decisions for your land
- **Recommendations tailed for your property**: Not all land is the same, and it's important to make sure you plant the right crops for the right plot. Annapurna's visualization software + agriculture analysis ensures that you'll be able to make the best decisions for your land
