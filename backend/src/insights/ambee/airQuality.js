...
exports.getAirQuality = void 0;
const axios_1 = __importDefault(require("axios"));
const configuration_1 = require("src/configuration");
const getAirQuality = (lat, lng) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.request({
            url: 'https://api.ambeedata.com/air-quality/latest/by-lat-lng',
