...
exports.getPollenHistory = void 0;
const axios_1 = __importDefault(require("axios"));
const configuration_1 = require("src/configuration");
const getPollenHistory = (lat, lng, from, to) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getPollenHistory = getPollenHistory;
